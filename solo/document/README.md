...
**Preview this layout:** [Document demo](https://loganmjones.github.io/PortfolioTraining/themes/document.html)
...
| `css/document.css` | Colors and layout |
...
Download the [ZIP](https://github.com/LoganMJones/PortfolioTraining/raw/main/solo/zips/document.zip) and upload files to a new repo manually.
