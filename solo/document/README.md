# Document Layout — Solo Package

This folder is **only** the Document layout — no other themes, no layout picker.

## Quick start (no Terminal)

1. **Download:** [Document layout ZIP](https://github.com/LoganMJones/PortfolioTraining/raw/main/solo/zips/document.zip)
...
css/document.css  ← colors & layout
js/main.js
