# Bold Layout — Solo Package

This folder is **only** the Bold layout — no other themes, no layout picker.

## Quick start (no Terminal)

1. **Download:** [Bold layout ZIP](https://github.com/LoganMJones/PortfolioTraining/raw/main/solo/zips/bold.zip)
