# Classic Layout — Solo Package

This folder is **only** the Classic layout — no other themes, no layout picker.

## Quick start (no Terminal)

1. **Download:** [Classic layout ZIP](https://github.com/LoganMJones/PortfolioTraining/raw/main/solo/zips/classic.zip)
