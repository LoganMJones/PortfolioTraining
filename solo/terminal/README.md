...
**Preview this layout:** [Terminal demo](https://loganmjones.github.io/PortfolioTraining/themes/terminal.html)
...
5. Colors: edit `css/terminal.css` — only the hex codes at the top.
...
## What you need to fill out Terminal
...
- Research — 2 lines
- Skills — one line
- Email, GitHub, and CV filename in contact block
...
|----------|----------|-------|
| CV | `assets/cv.pdf` | Linked as cv.pdf in contact block |

### Video

- 1× — YouTube/Vimeo embed or &lt;video&gt; file in assets/
...
| `css/terminal.css` | Colors and layout |
...
Download the [ZIP](https://github.com/LoganMJones/PortfolioTraining/raw/main/solo/zips/terminal.zip) and upload files to a new repo manually.
