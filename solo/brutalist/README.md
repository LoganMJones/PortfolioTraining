...
**Preview this layout:** [Brutalist demo](https://loganmjones.github.io/PortfolioTraining/themes/brutalist.html)
...
5. Colors: edit `css/brutalist.css`. Change only the hex codes at the top.
...
**1 images total.** JPG recommended, about 500 KB each after compression.
...
| `css/brutalist.css` | Colors and layout |
...
Download the [ZIP](https://github.com/LoganMJones/PortfolioTraining/raw/main/solo/zips/brutalist.zip) and upload files to a new repo manually.
